...
public class OcrResult {
	...
	public OcrResult(File image,ArrayList<String> words, ArrayList<Rectangle> bBoxes, ArrayList<Float> conf,int totLines, ArrayList<Integer> lineIndices,ArrayList<Integer> columnIndices,ArrayList<Integer> totWordInLine) {
	 ...
	 */
	public OcrResult(File image, ArrayList<String> words, ArrayList<Rectangle> bBoxes, ArrayList<Float> conf, TesseractLine lines) {
