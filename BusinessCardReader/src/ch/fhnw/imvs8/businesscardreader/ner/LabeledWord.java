...
public class LabeledWord {
	...
	public static final String[] HUMAN_READABLE_LABELS = { "Title","First Name", "Last Name", "Street", "Zip Code", "City", null," Mobile Number",null,"Telephone Number", null, "Fax Number", "Email","Web", "Organisation","Unknown"};
